...
<h1>contact</h1>
 ...
 <a href="formcontact.html" class="btn btn-primary mb-3  ml-5">Add New</a>
...
?>
  ...
  <tr>
    ...
    <td><?php echo $row["problem"]; ?></td>
		...
		<td><a class="btn btn-primary btn-sm" href="tablecontactupdate.php?id=<?php echo $row["id"]; ?>">Update</a>
    <a class="btn btn-danger btn-sm" href="tablecontactdelete.php?id=<?php echo $row["id"]; ?>">Delete</a></td>
